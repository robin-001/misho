 ...
 */
public class ParcelMRZInfo extends AbstractLDSInfo implements Parcelable {
     ...
     */
    public ParcelMRZInfo(String documentCode, String issuingState,
     ...
     */
    public ParcelMRZInfo(String documentCode,
                   String issuingState,
     ...
     */
    public ParcelMRZInfo(InputStream inputStream, int length) {
        try {
     ...
     */
    public ParcelMRZInfo(String str) {
        if (str == null) {
    ...
    public static final Creator<ParcelMRZInfo> CREATOR = new Creator<ParcelMRZInfo>() {
        @Override
        public ParcelMRZInfo createFromParcel(Parcel in) {
            return new ParcelMRZInfo(in);
        }

        @Override
        public ParcelMRZInfo[] newArray(int size) {
            return new ParcelMRZInfo[size];
        }
    };
    ...
    private void readObject(InputStream inputStream, int length) throws IOException {
        ...
        if (this.documentType == DOC_TYPE_ID1) {
            ...
            /* line 2, pos 8, Sex */
            this.gender = readGender(dataIn).toString();
    ...
    public boolean equals(Object obj) {
        ...
        ParcelMRZInfo other = (ParcelMRZInfo)obj;
    ...
    //Parcelling our mrz info
    public ParcelMRZInfo(Parcel in){
        ...
        this.secondaryIdentifier = in.readString();
        this.documentNumber = trimFillerChars(in.readString());
        this.nationality = in.readString();
        this.dateOfBirth = in.readString();
        this.gender = in.readString();
        this.dateOfExpiry = in.readString();
        this.optionalData1 = in.readString();
        this.optionalData2 = in.readString();
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt((int) documentNumberCheckDigit);
        dest.writeInt((int) dateOfBirthCheckDigit);
        dest.writeInt((int) dateOfExpiryCheckDigit);
        dest.writeInt((int) compositeCheckDigit);
