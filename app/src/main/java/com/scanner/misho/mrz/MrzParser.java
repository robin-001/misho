...
import com.scanner.misho.mrz.types.MrzDate;
import com.scanner.misho.mrz.types.MrzFormat;
import com.scanner.misho.mrz.types.MrzSex;
...
public class MrzParser {
    ...
    public MrzDate parseDate(MrzRange range) {
        ...
        try {
            ...
            year = -1;
            Log.d(TAG,"Failed to parse MRZ date year " + rawValue(range) + ": " + ex);
        }
        if (year < 0 || year > 99) {
        ...
        try {
            ...
            month = -1;
            Log.d(TAG,"Failed to parse MRZ date month " + rawValue(range) + ": " + ex);
        }
        if (month < 1 || month > 12) {
