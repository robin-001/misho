...
import com.scanner.misho.camera.CameraManager;
import com.scanner.misho.camera.ShutterButton;
import com.scanner.misho.mrz.ParcelMRZInfo;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback,
    ...
    private static final String RAW_MRZ = "RAW_MRZ";
    ...
    private void initOcrEngine(File storageRoot, String languageCode, String languageName) {
        ...
        //indeterminateDialog.show(); INITIALIZE TESARACT
    ...
    void handleOcrContinuousDecode(OcrResult ocrResult) {
        ...
        if (result != null && !"".equals(result)) {
            ...
            if (ocrResult.getMeanConfidence() >= MINIMUM_MEAN_CONFIDENCE && textResultTmpArr.length >= 2 && textResultTmpArr.length <= 3) {
                try {
                    ...
                    if (mrzInfo.toString().equals(result)) {
                        ...
                        data.putExtra(MRZ_RESULT,mrzInfo.toString());
                        data.putExtra(RAW_MRZ,result);
